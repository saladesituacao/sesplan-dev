...
if(!empty($id)) {
    ...
    $q1 = pg_query("SELECT * FROM tb_tarefa_plano_acao WHERE cod_tarefa_plano_acao = '$id'");
    $rs1 = pg_fetch_array($q1);

    $txt_tarefa = trim($rs1['txt_tarefa']);
    $txt_escopo_tarefa = trim($rs1['txt_escopo_tarefa']);    		
...
<div id="main" class="container-fluid">
    ...
    <form id="frm1" action="manter_tarefa.php">
        ...
        <?php if(empty($id)) {
        ?>
            <input type="hidden" name="acao" id="acao" value="incluir_tarefa" />
        <?php
        } 
        else {
        ?>
            <input type="hidden" name="acao" id="acao" value="alterar_tarefa" />
        <?php
        }
        ?>   
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="txt_tarefa" name="txt_tarefa" placeholder="Obrigatório" value="<?=$txt_tarefa?>">
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <textarea class="form-control" rows="5" id="txt_escopo_tarefa" name="txt_escopo_tarefa" placeholder="Obrigatório"><?=$txt_escopo_tarefa?></textarea>
            </div>	 
        ...
        <div class="row">
            ...
            <div class="col-md-6">                        
                ...
                ?>                  	  	
                <a href="listar_tarefa.php?id=<?php echo $idPlanoAcao ?>" class="btn btn-default">Voltar</a>
            </div>
        </div>
    </form>
</div>
